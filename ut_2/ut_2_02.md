...
- [U.T. 2 Primeros pasos con Blender](#ut-2-primeros-pasos-con-blender)
  - [Edición de objetos](#edición-de-objetos)
    ...
    - [Unión de objetos](#unión-de-objetos)
      ...
      - [Página 360 del libro trciks](#página-360-del-libro-trciks)
...
- Unión automática. En la barra del visor 3D aparece el botón de unión automártica de vértices, que si está seleccionado nos fusionará dos vértices que estén en la misma posición sin que hagamos nada. Generalmente es un funcionamiento que nos interesa tener activado pero habrá situaciones en las que necesitemos ambos vértices.
