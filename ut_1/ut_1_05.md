...
### Modo alambre
Hemos mencionado que cuando hacemos una selección por defecto solo se realiza sobre lo visible, todos los objetos que están detrás no se seleccionan. Para cambiar este comportamiento podemos pasar temporalmente al modo alambre, en el que se visualizarán todos los objetos seleccionables y se usarán todos.
